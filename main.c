      ...
      return simplegit_init();
        ...
        if (strcmp(argv[1], "add") == 0 || strcmp(argv[1], "rm") == 0) {
          ...
          if (strcmp(argv[1], "rm") == 0) {
            return simplegit_rm(argv[2]);
          } else {
            return simplegit_add(argv[2]);
          }
          ...
          return simplegit_commit(argv[3]);

        } else if (strcmp(argv[1], "status") == 0) {
            return simplegit_status();
            ...
            return simplegit_log(limit);
        } else if (strcmp(argv[1], "branch") == 0) {
            return simplegit_branch();
            ...
            return simplegit_checkout(arg, branch_new);
        } else {
