...
mkdir test
touch test/.simplegit_TEST_IGNORE_ME
...
cd test
echo
echo  '*** WELCOME TO YOUR simplegit TEST DIRECTORY ***'
echo
echo 'You are now in the test directory, which is a brand-new directory created for'
echo 'you to test out your simplegit implementation. Your source directory has also'
echo 'been added to the PATH, so you can just type commands such as "simplegit init" to'
